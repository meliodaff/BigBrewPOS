...
const HotBrewAddOns = (props) => {
  ...
  const handleClick = () => {
    ...
    const newItem = {
      id: props.hotBrew.id,
      drinkName: props.hotBrew.drinkName,
      drinkSize: size,
      drinkImage: props.hotBrew.drinkImage,
      drinkAddOns: addOns,
      price: priceForSize + priceForAddOns,
      drinkCategory: props.hotBrew.drinkCategory,
    };
